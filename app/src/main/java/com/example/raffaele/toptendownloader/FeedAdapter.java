...
//        TextView tvSummary = (TextView) convertView.findViewById(R.id.tvSummary);
     ...
     * migliorare le prestazioni del dispositivo (consumo eccessivo della RAM, ad esempio), è necessario
     * "riciclare" gli oggetti che rappresentano ciascuna riga della nostra lista in modo da evitare
     * di fare quello che in gergo si chiama "inflate" e di chiamare il metodo findViewById quando se
